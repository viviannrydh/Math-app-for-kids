  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="form-wrapper">
        <button className="minus-first">{firstNumber}</button>
        <span>-</span>
        <button className="minus-second">{secondNumber}</button>
        <span>=</span>
        <input type="text" value={answer} name="totalInput" onChange={handleChange} className="minus-answer" />
      </form>
